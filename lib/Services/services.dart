...
import 'package:weather_only/Model/weather_model.dart';
...
class WeatherServices {
  fetchWeather() async {
    final response = await http.get(
      Uri.parse(
          "https://api.openweathermap.org/data/2.5/weather?lat=12.9715&lon=77.5945&appid=509079b22fae7e954dff8403ef5eba0e"),
    );
